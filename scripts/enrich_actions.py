...
PARSER_RULES = {
    ...
    "veeam_": "generic_parser",
    "eternalblue": "generic_parser",
    "lsass_": "generic_parser",
    "mscache2": "impacket_parser",
    "sam_offline": "impacket_parser",
    "dpapi_masterkey": "generic_parser",
    "smbghost": "generic_parser",
    "serioussam": "generic_parser",
    "uac_bypass": "generic_parser",
    "applocker_bypass": "generic_parser",
    "remotepotato": "generic_parser",
    "roguepotato": "generic_parser",
    "privexchange": "generic_parser",
    "keepass_": "generic_parser",
    "timeroast": "generic_parser",
    "goldenpac": "impacket_parser",
    "nopac": "impacket_parser",
    "saphire": "impacket_parser",
    "certifried": "generic_parser",
    "dsrm_": "generic_parser",
    "dc_shadow": "generic_parser",
    "custom_ssp": "generic_parser",
    "trust_key_": "generic_parser",
    "trust_ticket_": "impacket_parser",
    "krbrelayup": "generic_parser",
    "passthecert": "generic_parser",
    "blind_kerberoast": "impacket_parser",
    "dnsadmins": "generic_parser",
    "mitm6": "generic_parser",
    "ntlm_theft_file_drop": "generic_parser",
    "targetedkerberoast": "impacket_parser",
    # Perception gap fixes (v2.2)
    "playwright_screenshot": "playwright_parser",
    "playwright_crawl": "playwright_parser",
    "timing_probe": "timing_parser",
    "js_secrets_scan": "web_response_parser",
    "honeypot_detect": "generic_parser",
}
